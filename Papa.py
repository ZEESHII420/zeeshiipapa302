...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕ZESHI▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕PAPA ▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mZEESHIIPAPA.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mZEESHIIPAPA\033[1;91m...............
...
\033[1;91m☞ Auther     : ZEESHII PAPA KING MAKER
\033[1;92m☞ WhatsApp   : 03072780963
\033[1;95m☞   : --------------------------/------------
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ZEESHII PAPA TOOLS')
	print (S + '[' + P + '☞3' + S + ']' + S + ' ZEESHII PAPA SB KA BAP')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf papa/ZEESHII PAPA')
	    os.system('cd zeeshiipapa && git clone https://github.com/ZEESHII420/ZEESHII302')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03072780963✓')
	    psb('WellCome To ZEESHII PAPA')
	    psb('Congratulations ZEESHII PAPA Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ ZEESHII✓')
	    psb('🔓Password ☆ PAPA✓')
	    psb('SHAREKO KA BAP HU MA DOST KA DOST AUR DUSHMNO KA DUSHMN --------------------------------------------------✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd zeeshiipappa/ZEESHII PAPA && python2 B4.py')
	elif bm =='3':
